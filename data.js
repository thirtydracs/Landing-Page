const projects = [
  {
    ...
    status: "Behind",
    summary: "Demolition issues still holding programme back despite progress on other fronts.",
    holding: "Ace Demolition non-performance",
  ...
  },
  {
    ...
    summary: "Site prep largely complete but fragile due to low labour and reliance on concreting start.",
    holding: "Concreting start post-Easter",
  ...
  },
  {
    ...
    status: "Unknown",
    summary: "Work progressing but no structured logs — programme position unclear.",
    holding: "No structured logs",
